...
local function generate_header()
    ...
    text = text .. bottom_left_corner .. vim.fn["repeat"](horizontal_line, width + 2) .. bottom_right_corner .. "\n" .. cow
    return {
        type = "text",
...
local function button(sc, txt, keybind, keybind_opts)
    ...
    local opts = {
        ...
        -- width = 50,
        align_shortcut = "left",
        hl_shortcut = { { "Text", 0, 1 }, { "StartifyNumber", 1, #sc + 1 }, { "Text", #sc + 1, #sc + 2 } },
        shrink_margin = false,
    }
    if keybind then
...
local section = {
    ...
    mru = {
        ...
        val = {
            { type = "padding", val = 1 },
            { type = "text", val = "MRU", opts = { hl = "rustMacro" } },
            { type = "padding", val = 1 },
            {
                type = "group",
                val = function()
    ...
    mru_cwd = {
        ...
        val = {
            { type = "padding", val = 1 },
            { type = "text", val = mru_title, opts = { hl = "rustMacro", shrink_margin = false } },
            { type = "padding", val = 1 },
            {
                type = "group",
                val = function()
